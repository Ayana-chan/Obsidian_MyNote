...
$$H_0:\theta\in\Theta_0,H_1:\theta\in\Theta_1$$
可以类似地定义似然比检验统计量为：
$$\lambda\left(x\right)=\frac{\sup_{\theta\in\Theta_{1}}\left\{p\left(x_{1},\cdots,x_{n};\theta\right)\right\}}{\sup_{\theta\in\Theta_{0}}\left\{p\left(x_{1},\cdots,x_{n};\theta\right)\right\}}$$
...
同样地，拒绝域为$W = \{ x: \lambda(x) \geq c \}$，其中临界值$c$由$P_{\theta_0} \{ \lambda(x) \geq c \} \leq \alpha, \theta_o \in \Theta_0$来确定。

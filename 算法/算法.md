...
每个优化问题都有<u>对应的判定问题</u>: 此问题下是否存在一个可行解$y$, 其对应值不劣于目标值$K$. 
...
假设$Q$是一个<u>NPO问题</u>, 如果<u>存在</u>常数$r \geq 1$, 使得$Q$有一个<u>多项式时间</u>的<u>r-近似算法</u>, 则称$Q$属于**APX类**.

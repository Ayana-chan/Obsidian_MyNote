...
哲学当中也会有和哲学史一样的对 development of thinking 的表述, 只不过摆脱了历史性的外在性, 单纯地集中于 the element of thinking.
...
每一个circle个体, 仅因为它本身就是totality, 就要突破其element的boundary达到更远的范围(sphere). 这个whole也因此表现为 circle of circles, 而且每一个circles都是一个necessary moment. 于是它的distinctive elements 的 system 组成了 完全的idea(the idea in its entirety), 而且这idea也同样出现在每一个circles当中.

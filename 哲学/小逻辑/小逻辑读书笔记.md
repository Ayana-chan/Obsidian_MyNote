...
推论(Sculuß)也叫三段论(syllogism), 黑格尔特指被他辩证改造过的三段论. 推论规定: the particular is supposed to be the middle that joins the extremes of the universal and the individual together (特殊是普遍和个别这两个极端结合起来的中项).

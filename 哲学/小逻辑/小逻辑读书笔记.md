...
既认为thinking与对象的关系被看做是acive的, 被看做是 Nachdenken(后思), 那么 这样的activity所产出的universal就蕴含了这些东西的价值: the Sache, the essential, the inner, the true.
...
- 研究自然现象时, 人们看到雷, 也不满足于感性现象, 而是想要知道\[wissen\]它背后是什么, 想要知道 一个东西 与 现象 as such 的区别的原因, 还有 与单纯的outer有所区别的inner. 

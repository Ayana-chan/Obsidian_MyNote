...
逻辑学的一个主要方面是, 意识到 dialectic 构成了 thinking 的根本 nature, 意识到 understanding 必然落于其negative(或落于contradiction).
...
康德的一个重大成果: 把 我们的直接意识的对象(即那些形成经验知识的内容的东西) 解释为单纯的appearances. 指出了我们直接知晓的对象仅仅是appearance, 即 其存在的根据不在其自身内, 而在一个other内. 事物的自在存在对我们来说是不可到达的彼岸. 真正的关系是: 我们直接知晓的对象 对我们和 in themselves **都**仅仅是 appearance. 这是绝对观念论(absolute idealism)的观点.
...
唯有精神的本性(spiritual nature) 才是 thinking the absolute 的最有价值和最真的出发点.
...
这样的理性不如叫做完全的抽象思维, 只能提供批判, 如康德所认为的以某种不矛盾的原则去处理知觉材料. 这样的思维可以说 本身就是 无规定的统一(indeterminate unity), 并且是这无规定的统一的活动.


### 53

实践理性(practical reason) 是 思维着的意志(thinking will), 即 以普遍的方式规定自己 的意志.


### 54

之前所讨论是理性是消极的, 仅仅是为了批判经验知识的有限性. 现在, 认为意志有能力采取 普遍的方式(即思维) 规定自身, 


### 55

康德认为 反思的判断力(power of reflective judgment) 是 直观的知性(intuiting understanding)的法则.


### 56

康德(在此)提出了另外的 知性的普遍概念 和 感性的特殊事物之间的关系的思想, 但只认为其存在于有限的表现乃至经验中.


### 57

与自然的活产物相关的 判断的反思力量(the reflective power of judgment)的原则 被定义为 **目的(purpose)**. 目的是the active concept, the universal that is determined and determining in itself.


### 58

批判哲学得出的一个结论是: 理性只能认识表现. (这也可以概括康德对意识各阶段的反思).


### 60

在二元体系(尤其是康德体系)里面, 其错误由这样的<u>不一致性</u>中显现: 去把刚刚声明的**独立的**(也即**不可结合的**\[unvereinbar\])东西 给**结合**\[vereinen\]了. 在被结合的东西被声明为真的同时, 又声明两个环节(仅在其分离存在的时候)持有真理, 而这"两个环节"天然禁止了结合. 这样的往复运动恰恰说明任一环节都不能得到满足. 这样的体系缺失了把两个思想联系在一起的能力. 一个矛盾是, 康德认为知性只能获得表现的知识, 但又坚持认识是绝对的(绝对性体现在 对认识的界限的绝对论断).

一个人意识到他自己的限制或缺陷的时候, 就已经超出这限制或缺陷了.

有无限的东西在我们意识里面(exists on this side, in consciousness)的时候, 才能获得对于限制的知识.

**康德哲学的主要作用**在于唤醒了理性的意识, 或**思想的绝对内在性**(绝对拒绝接受和容许任何外在性的东西). 在此之后, 理性独立的原则, 理性的绝对自主性, 成为了哲学的普遍原则.

---

批判哲学的片面性, 在于认为知性范畴之所以有限, 是因为它是主观的; 实际上, 是因为它自身就是有限的, 需要自己显现其有限性. 此外, 在现象阶段, 思维并没有结束, 此后的东西康德没有到达.

---

康德对 思维如何在其自身之外规定自身 所遵守的法则 仅仅是以形式的方式建立的, 却没有说明这种自我规定是如何进行的以及是在什么方面的. **费希特**发现这一点, 尝试使用自我的活动推出范畴. 但费希特的自我不是自由自发的, 需要外部刺激, 通过反抗外部刺激才能达到自身的自我意识; 刺激总是作为异己的外力, 因此自我总是有限的, 与他物对立. 因此费希特依然认为**有限的才能被认识**. 康德的物自体在费希特那里就对应着**外来刺激**, 它是一个无法规定的抽象体, 因此笼统称作**非我**.

# C. Third Position of Thought Towards Objectivity: Immediate knowing

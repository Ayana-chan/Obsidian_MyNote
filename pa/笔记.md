...
[[ELF文件解析] 读取ELF文件\_elf文件在线解析\_HNU\_ZHAO的博客-CSDN博客](https://blog.csdn.net/qq_42474104/article/details/130455138)这个链接是64位的，只要把64全部替换成32即可。

[ICS PA2 实验记录 - 知乎](https://zhuanlan.zhihu.com/p/506323862)
